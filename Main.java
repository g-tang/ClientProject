...
public class Main extends Application {
	...
	public void start(Stage s) {
		try {
			...
			pText promptBell=new pText("Select a bell schedule",200,520);
			...
			pText promptSem=new pText("Select current semester:",200,690);
			...
			pText promptAdminEmail=new pText("Enter the admin email address:",900,690);
			...
			PasswordField enterAdminEmailPWord=new PasswordField();
			enterAdminEmailPWord.setPromptText("Password");
			enterAdminEmailPWord.setMinSize(300, 50);
			enterAdminEmailPWord.setLayoutX(900);enterAdminEmailPWord.setLayoutY(800);
			settingsGrid.getChildren().add(enterAdminEmailPWord);
			
			pText adminError=new pText("Invalid admin address/password",900,900);
			...
			pText wrongPassword=new pText("Wrong password!",500,600);
			...
			submit.setOnAction(e->{
				...
				try{
					...
					System.out.println("Send email?"+administrator.getEmail());
					System.out.println(new File("DoNotTouch/AdminEmail"));
